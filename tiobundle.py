"""
This script generates tiobundle when model.json, assets/labels.txt, and model.tflite are in place.

tflite can be generated by:
tflite_convert \
...
python tiobundle.py \
    ...
    --assets-dir ./assets \
    --bundle-name <name>.tiobundle \
    --outfile <name>.tiobundle.zip
"""
